...
class Node_LoseAFightRequirement : public Node
{
public:
	Node_LoseAFightRequirement(int id) : Node(id) { // Call the base class constructor  
		ID = id;
		Name = "Lost A Fight";
	...
	void RenderDetails() override
	{
		...
		if (pinataNode == nullptr) {
			...
			ImGui::Text("Pinata Node disconnected from Lost A Fight");
			ImGui::PopStyleColor();
		}
		else {
